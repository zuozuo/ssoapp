...
SimpleForm.setup do |config|
  ...
  config.wrappers :bootstrap3, tag: 'div', class: 'form-group', error_class: 'has-error',
    ...
    b.use :label, :wrap_with => { :class => 'inline-label col-sm-2' }
    b.wrapper tag: 'div', class: 'col-sm-10 inline-input' do |input|
      input.use :input
  ...
  config.wrappers :no_label, tag: 'div', class: 'form-group', error_class: 'has-error',
      defaults: { input_html: { class: 'default_class' } } do |b|
